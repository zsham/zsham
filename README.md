...
<p align="center" dir="auto">
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=FF8D20&center=true&random=true&width=1000&lines=Graduate+of+Universiti+Industri+Selangor+(UNiSEL);with+a+Diploma+in+Information+Technology;and+Graduate+of+Universiti+Teknologi+Malaysia+(UTM);with+a+Bachelor's+Degree+in+Computer+Science+(Software+ Engineering)" alt="Typing SVG" />
